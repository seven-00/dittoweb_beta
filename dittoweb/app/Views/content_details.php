...
<body>
    ...
    <!-- Product section-->
    <section class="py-1  text-white bg-dark">
        <div class="container px-4 px-lg-5 my-5">
            <div class="row gx-4 gx-lg-5">
                <div class="col-md-4"><img class="card-img-top mb-5 mb-md-0" src="<?php echo $contentdatapayload['content_photo_url'] ?>" alt="..." /></div>
                    ...
                    <?php foreach ($contentreviewspayload as $review) { ?>
                        <ul class="list-group">
                            <li class="list-group-item">
                                <strong><?php print_r($review['user']) ?></strong>
                                <p><?php print_r($review['review']) ?></p>
                            </li>
                            <br>
                        </ul>
                    <?php } ?>
            ...
            <div class="col-md-6">
                ...
                <form action="/dittoweb.com/content/add_review/<?php echo $contentpayload['content_id']; ?>" method="POST">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name = "review" id="review" rows="5" placeholder="Write your review"></textarea>
                    </div>
                    <br>
